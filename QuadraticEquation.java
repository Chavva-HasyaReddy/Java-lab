...
public class QuadraticEquation
{
   public static void main(String args[])
   {
      ...
      System.out.print("Enter the coefficient for quadratic term :");
      double a = reader.nextDouble();
      System.out.print("Enter the coefficient for linear term :");
      double b =reader.nextDouble();
      System.out.print("Enter the coefficient for constant term :");
